              ...
              <form onSubmit={handleAddMember} className="space-y-4">
                <div>
                  <input
                    ...
                    className="w-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 px-4 py-3 mb-4 focus:outline-none focus:border-[var(--columbia-blue-light)] text-black dark:text-white text-sm placeholder:text-black dark:placeholder:text-white/20 rounded-xl transition-all shadow-inner"
                  />
                  <select
                    value={roleInput}
                  ...
                  <input
                    ...
                    className="w-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 px-4 py-3 focus:outline-none focus:border-[var(--columbia-blue-light)] text-black dark:text-white text-sm placeholder:text-black dark:placeholder:text-white/20 rounded-xl transition-all shadow-inner"
                  />
                </div>
                <button
                  type="submit"
                  disabled={adminStatus === 'loading'}
                  className="w-full flex items-center justify-center gap-2 bg-[var(--foreground)] text-[var(--background)] hover:opacity-90 font-semibold text-sm px-6 py-3 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)] dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] active:scale-[0.98] disabled:opacity-50"
                >
            ...
            <div className="glass-panel p-6 rounded-xl">
              ...
              <form onSubmit={handleAddTip} className="space-y-4">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 px-4 py-3 focus:outline-none focus:border-[var(--columbia-blue-light)] text-black dark:text-white text-sm placeholder:text-black dark:placeholder:text-white/20 rounded-xl transition-all shadow-inner resize-none"
                />
                <button
                  type="submit"
