            ...
            <div className="space-y-4 text-[16px] leading-[1.8]">
              ...
              <div>
                <button
                  ...
                  className="font-serif text-2xl text-white hover:text-[var(--columbia-blue-light)] transition-colors duration-300"
                >
            ...
            <form onSubmit={handleSubmit} className="glass-panel p-8 md:p-12 rounded-3xl space-y-10 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent border-b border-white/10 py-2 focus:outline-none focus:border-[var(--columbia-blue-light)] text-white text-sm placeholder:text-white/20 transition-colors"
                  />
                </div>
                <div className="space-y-3">
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  className="w-full bg-transparent border-b border-white/10 py-2 focus:outline-none focus:border-[var(--columbia-blue-light)] text-white text-sm placeholder:text-white/20 transition-colors resize-none"
                />
              </div>
